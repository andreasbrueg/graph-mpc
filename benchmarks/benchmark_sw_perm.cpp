...
void benchmark(Party id, RandomGenerators &rngs, std::shared_ptr<NetworkInterface> network, size_t n, size_t BLOCK_SIZE, size_t repeat, size_t n_vertices,
    ...
    auto p1 = Permutation::random(n, rngs.rng_01());
    auto p2 = Permutation::random(n, rngs.rng_01());

    auto p1_share = share::random_share_secret_perm_2P(id, rngs, p1);
    auto p2_share = share::random_share_secret_perm_2P(id, rngs, p2);

    auto permuted_input_vec = permute::apply_perm(id, rngs, network, n, p1_share, input_share);
    ...
    for (size_t r = 0; r < repeat; ++r) {
        ...
        auto sw_perm_preproc = permute::switch_perm_preprocess(id, rngs, network, n);
        ...
        auto switched_perm = permute::switch_perm_evaluate(id, rngs, network, n, p1_share, p2_share, sw_perm_preproc, permuted_input_vec);
